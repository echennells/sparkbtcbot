...
1. **Catalog discovery** (read-only): `GET https://x402.cryptorefills.com/v1/brands?country_code=us` (lowercase ISO) — their x402 host's catalog works and prices match. Cheapest known SKU: Tango $1 (US).
