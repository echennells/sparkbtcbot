...
const preview = await previewL402("https://api.example.com/paid-endpoint");
...
A runnable version of this flow (with token caching) ships as `scripts/l402-paywalls.js` — prefer it over re-deriving your own copy.
