...
// process, which can call the SDK directly or delete the ledger file. The
// only spending authority that survives process compromise is server-side
// (sparkbtcbot-proxy's maxTxSats / dailyBudgetSats).
//
// Failure posture:
...
//     agents separate ledger files and budgets.
